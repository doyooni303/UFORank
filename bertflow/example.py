...
if __name__ == "__main__":
    ...
    bertflow = TransformerGlow(
        model_name_or_path, pooling="first-last-avg"
    ...
    ]  # Please replace this with your datasets (single sentences).
    ...
    for _ in range(10):
        ...
        z, loss = bertflow(
            model_inputs["input_ids"], model_inputs["attention_mask"], return_loss=True
    ...
    bertflow.save_pretrained("output2")  # Save model
